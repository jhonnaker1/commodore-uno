...
/* One fanned row. At 20 cards the fan tightens to an 11-pixel step and
   still fits across the 256-pixel screen, so unlike the Amiga build there
   is no need for a second row. */
