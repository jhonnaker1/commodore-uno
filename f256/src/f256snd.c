#include "f256snd.h"
#include "f256vid.h"    /* wait_vsync() */

/* Left SID at $D400, register-identical to a real 6581/8580 -- this is the
   C64 port's sid.c, re-based on nothing (same $D400 address) with
   VIC-raster frame pacing swapped for wait_vsync(). */
