...
/* Ten cards per row, two rows. At 80 columns a 7-wide tile plus a gap
   divides into exactly ten, so the hand needs no overlapping fan the way
   the narrower bitmap ports do. */
#define HAND_PER_ROW 10
